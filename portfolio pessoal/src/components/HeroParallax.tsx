  ...
  return (
    ...
    >
      <defs>
        ...
        >
          <stop offset="0.07" stopColor="#1a5c42" />
          <stop offset="0.98" stopColor="#2d8a6a" />
        </linearGradient>
        <radialGradient id="hp-bg_grad" cx="375" cy="-30" r="318.69" gradientUnits="userSpaceOnUse">
          <stop offset="0.1" stopColor="#39ff14" id="hp-sun" />
          <stop offset="0.15" stopColor="#7dff6b" />
          <stop offset="0.25" stopColor="#00d4ff" />
          <stop offset="0.45" stopColor="#1a3d52" />
          <stop offset="0.8" stopColor="#05070c" />
        </radialGradient>
        <linearGradient id="hp-grad2" x1="242.5" y1="356.25" x2="750" y2="356.25" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#1e6b5a" />
          <stop offset="0.98" stopColor="#0d3d4a" />
        </linearGradient>
        <linearGradient id="hp-grad3" x1="467.26" y1="500" x2="467.26" y2="225.47" gradientUnits="userSpaceOnUse">
          <stop offset="0.01" stopColor="#00d4ff" />
          <stop offset="1" stopColor="#1a2f4a" />
        </linearGradient>
        <linearGradient id="hp-grad5" x1="1" y1="413.12" x2="340.58" y2="413.12" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#2a2548" />
          <stop offset="1" stopColor="#1a1830" />
        </linearGradient>
        <linearGradient id="hp-grad7" x1="434.38" y1="391.96" x2="474.27" y2="516.33" gradientUnits="userSpaceOnUse">
          <stop offset="0.3" stopColor="#0e0c1c" />
          <stop offset="0.38" stopColor="#141228" />
          <stop offset="0.9" stopColor="#2a2450" />
        </linearGradient>
        <linearGradient id="hp-grad8" x1="259.18" y1="335.54" x2="213.65" y2="500.39" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#05070c" />
          <stop offset="0.3" stopColor="#080a12" />
          <stop offset="0.64" stopColor="#0d1020" />
          <stop offset="0.95" stopColor="#15182e" />
        </linearGradient>
        <linearGradient id="hp-grad9" x1="508.16" y1="321.39" x2="726.97" y2="623.69" gradientUnits="userSpaceOnUse">
          <stop offset="0.01" stopColor="#060810" />
          <stop offset="1" stopColor="#1a1838" />
        </linearGradient>
      </defs>

      <rect id="hp-bg" width="750" height="500" opacity="0.85" fill="url(#hp-bg_grad)" />

      <g id="hp-clouds" fill="#e8eef6" opacity="0.9">
        <path
          id="hp-cloud4"
...
export function HeroParallax({ sectionRef }: { sectionRef: RefObject<HTMLElement | null> }) {
  ...
  useEffect(() => {
    ...
    gsap.set("#hp-bg_grad", { attr: { cy: "-50" } });
    ...
    const ctx = gsap.context(() => {
      ...
      scene1.to("#hp-h1-1", { y: 3 * speed, x: speed, scale: 0.92, ease: "power1.in" }, 0);
      scene1.to("#hp-h1-2", { y: 2.6 * speed, x: -0.6 * speed, ease: "power1.in" }, 0);
      scene1.to("#hp-h1-3", { y: 1.7 * speed, x: 1.2 * speed }, 0.03);
      scene1.to("#hp-h1-5", { y: 2 * speed, x: speed }, 0.03);
      scene1.to("#hp-h1-7", { y: 5 * speed, x: 1.6 * speed }, 0);
      scene1.to("#hp-h1-8", { y: 3.5 * speed, x: 0.2 * speed }, 0);
      scene1.to("#hp-h1-9", { y: 3.5 * speed, x: -0.2 * speed }, 0);
      scene1.to("#hp-cloudsBig-L", { y: 4.5 * speed, x: -0.2 * speed }, 0);
      scene1.to("#hp-cloudsBig-R", { y: 4.5 * speed, x: -0.2 * speed }, 0);
      ...
      clouds.to("#hp-cloud1", { x: 400 }, 0);
      clouds.to("#hp-cloud2", { x: 800 }, 0);
      clouds.to("#hp-cloud3", { x: -800 }, 0);
      clouds.to("#hp-cloud4", { x: -500, y: 20 }, 0);
      ...
      sun.fromTo("#hp-bg_grad", { attr: { cy: "-50" } }, { attr: { cy: "280" } }, 0);
      sun.to("#hp-bg_grad stop:nth-child(2)", { attr: { offset: "0.2" } }, 0);
      sun.to("#hp-bg_grad stop:nth-child(3)", { attr: { offset: "0.35" } }, 0);
      sun.to("#hp-bg_grad stop:nth-child(5)", { attr: { "stop-color": "#0a1620" } }, 0);
    }, root);
  ...
  return (
    <div className="hero-parallax" ref={parallaxRef}>
      <HeroParallaxSvg />
      <div className="hero-parallax__fade" aria-hidden />
    </div>
  );
}
